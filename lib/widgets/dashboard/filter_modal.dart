...
class FilterModal extends StatefulWidget {
  ...
  const FilterModal({super.key, required this.onApply, required this.onClear});
...
class _FilterModalState extends State<FilterModal> {
  // Selection state
  String? _selectedStatus; // Radio behavior
  // ... other fields if needed

  // Data to match screenshot
  final Map<String, List<String>> _filters = {
    'Status': ['Opted-In', 'Opted-Out', 'Removed', 'Placed'],
  ...
  Widget _buildOptionItem(String option) {
    // For now, handling Status as Radio, others as Checkbox/Radio?
    // Image shows Radio buttons for Status. Assume single select for simplicity or match UI.
    bool isSelected = false;
    if (_selectedCategory == 'Status') {
